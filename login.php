...
<main>
  <h1 class="slideInDown animated">Please, Login with the Admin Account and Password</h1>
  ...
  <div class="slideInDown animated">
    <div class="login-page">
      <div class="form">
        ...
        <form class="login-form" action="login_ac.php" method="post" enctype="multipart/form-data">
          <input type="text" name="username" id="email" placeholder="Tài khoản..." required/>
          <input type="password" name="matkhau" id="pwd" placeholder="Mật khẩu" required/>
